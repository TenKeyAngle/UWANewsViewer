...
def create_db(db):
    try:
        if 'VCAP_SERVICES' in os.environ:
             db2info = json.loads(os.environ['VCAP_SERVICES'])['cloudantNoSQLDB'][0]
        else:
            return "0: help"
    except:
    ...
    try:
        ...
        return '2: A Cloudant service is not bound to the application.  Please bind a Cloudant service and try again.'
